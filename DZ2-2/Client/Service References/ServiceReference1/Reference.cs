...
namespace Client.ServiceReference1 {
    ...
    public interface IService1 {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/getContent", ReplyAction="http://tempuri.org/IService1/getContentResponse")]
        System.Threading.Tasks.Task<string[]> getContentAsync(string path);
    }
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<Client.ServiceReference1.IService1>, Client.ServiceReference1.IService1 {
        ...
        public string[] getContent(string path) {
            return base.Channel.getContent(path);
        }
        
        public System.Threading.Tasks.Task<string[]> getContentAsync(string path) {
            return base.Channel.getContentAsync(path);
        }
    }
}
